      ...
      {profileMenu && (
        <>
          ...
          >
            ...
            >
              {" "}
              <p className="text-secondary font-bold px-4 py-2 border-b-2 border-slate-800 transition-all hover:bg-dark hover:text-white rounded text-center cursor-pointer">
                {data.user.name}
              </p>
              <p
